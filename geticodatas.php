...
$url="https://api.coinmarketcap.com/v1/ticker/".$data[$k]['name']."/";
    ...
    $sql="update ico_Analysis set Current_market_value='".$Current_market_value."',Current_Cirulation='".$Current_Circulation."',Current_Single_price='".$Current_Single_price."' where name='".$data[$k]['name']."'";
    MySQLRunSQL($sql);
}
