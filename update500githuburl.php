...
$coinmarketmap=json_decode(file_get_contents_https("https://s2.coinmarketcap.com/generated/search/quick_search_exchanges.json"),true);
print_r(file_get_contents_https("https://s2.coinmarketcap.com/generated/search/quick_search_exchanges.json"));die;
