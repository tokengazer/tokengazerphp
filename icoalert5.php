...
$json='{"requests":[{"indexName":"icoalert-production-recent","params":"query=&hitsPerPage=10000&page=0&filters=endDate%20%3E%200%20AND%20endDate%20%3C%20'.time().'&facets=%5B%5D&tagFilters="}]}';
