...
$cell=explode(',',$cells);
$engcells=$cells;explode(",","id,name,ticker,logo,DataSource,Current_market_value,Current_Single_Price,Current_Circulation,Circulation_unit,Total_Count,perhour,perday,perweek,Twitter_Fanscount,Facebook_Friends,Telegram_fans,Github_url,GithubCommits,GithubStars,GithubWatches,GithubForks,Github_lastupdatetime,Ico_time,ICO_Price_Usd,ICO_Price_ETH,ICO_Distribution_Ratio,Presales,ICO_Total_Amount,ICO_TotalCount,perhour,perday,perweek,ICO_HardCap,ICO_Raise_money,Business,Technology,Team,Token,Operation,members,origin,whitepaper,website,cannotareas,Platform,icolink,linkedin,AcceptedCurrencies,TokenStandard,TokenType,AdditionalTokenEmission,AvailableforTokenSale,facebookurl,twitterurl,telegramurl,whitelist");
