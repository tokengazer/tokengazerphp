...
$json='{"requests":[{"indexName":"icoalert-production-active","params":"query=&hitsPerPage=10000&page=0&filters=startDate%20%3C%3D%20'.time().'%20AND%20endDate%20%3E%20'.time().'%20AND%20startDate%20%3E%200&facets=%5B%5D&tagFilters="}]}';
