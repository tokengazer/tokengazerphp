...
$url="https://icodrops.com/".str_replace(" ","-",trim($results[$k]['name']))."/";
    ...
    $githuburl="https://github.com/".explode("\"",explode("github.com/",$html)[1])[0;]
    ...
    $sql="update icco_Analysis set Github_url='".$githuburl."',whitepaper='".$whitepaper."',ticker='".$ticker."',whitelist='".$whitelist."',Ico_time='".$icostartdate."',Platform='".$platform."',cannotareas='".$cannotareas."',website='".$website."' where id=".$$results[$k]['id']."";
    MySQLRunSQL($sql);
}
?>