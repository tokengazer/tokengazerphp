...
$sql="select id, Github_url from ico_Analysis where Github_url <> '' and Github_url <>'https://github.com/'limit 0,10 ";
...
foreach($url as $kk=>$vv){
    ...
    echo 1;echo $re=curl_multi_getcontent($connlist[$dd]);
        print_r($re);
    }
